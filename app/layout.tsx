...
export const metadata: Metadata = {
  ...
  openGraph:{ title:'果汁碰碰杯', description:'滑動・碰撞・融合升級', images:[{url:'/og.png',width:1200,height:630,alt:'果汁碰碰杯'}] },
  twitter:{ card:'summary_large_image', title:'果汁碰碰杯', description:'滑動・碰撞・融合升級', images:['/og.png'] }
};
